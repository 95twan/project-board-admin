...
public class ArticleManagementService {
    ...
    public List<ArticleDto> getArticles() {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/articles")
    ...
    public ArticleDto getArticle(Long articleId) {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/articles/" + articleId)
                .build()
                .toUri();
