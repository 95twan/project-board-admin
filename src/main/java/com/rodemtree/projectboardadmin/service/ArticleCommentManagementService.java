...
import com.rodemtree.projectboardadmin.dto.response.ArticleCommentClientResponse;
...
public class ArticleCommentManagementService {
    ...
    public List<ArticleCommentDto> getArticleComments() {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/articleComments")
    ...
    public ArticleCommentDto getArticleComment(Long articleCommentId) {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/articleComments/" + articleCommentId)
                .build()
                .toUri();
