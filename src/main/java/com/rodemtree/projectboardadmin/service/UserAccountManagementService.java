...
import com.rodemtree.projectboardadmin.dto.response.UserAccountClientResponse;
...
public class UserAccountManagementService {
    ...
    public List<UserAccountDto> getUserAccounts() {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/userAccounts")
    ...
    public UserAccountDto getUserAccount(String userId) {
        URI uri = UriComponentsBuilder.fromUriString(projectProperties.board().url() + "/api/userAccounts/" + userId)
                .build()
                .toUri();
